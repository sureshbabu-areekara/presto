...
namespace {
core::TopNRowNumberNode::RankFunction prestoToVeloxRankFunction(protocol::RankingFunction rankingFunction) {
...
VeloxQueryPlanConverterBase::toVeloxQueryPlan(
  ...
  if (node->rankingType == protocol::RankingFunction::ROW_NUMBER && sortFields.empty()) {
